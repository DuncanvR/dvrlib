...
public class SimulatedAnnealing extends LocalSearch {
   ...
   protected int stopCount, coolCount;
   protected double temperature, tempMod;

   /**
    * SimulatedAnnealing constructor, using the default values for initTemp and tempMod.
    ...
    * @see SimulatedAnnealing#SimulatedAnnealing(int, int, double, double)
    */
   public SimulatedAnnealing(int stopCount, int coolCount) {
    ...
    */
   public SimulatedAnnealing(int stopCount, int coolCount, double initTemp, double tempMod) {
